plotlyVonMisesDistribution <- function(plotrange, input, distType, probrange, session) {
    ...
    xseq <- seq(min(-pi, as.numeric(plotrange[1])), max(as.numeric(plotrange[2]), pi), 0.01)
    f71 <- 0
    graphtype <- ""
