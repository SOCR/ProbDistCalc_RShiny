...
distributionInfoList <- list(
  ...
  "Bivariate Normal Distribution (3D)" = distributionInfoClass(10, "BivariateNormal3D", c("BivaM1", "BivaV1", "BivaM2", "BivaV2", "BivaCov"), c("mean of the first random variable", "variance of the first random variable", "mean for the second random variable", "variance of the second random variable", "covariance of the two random variables"), c(0, 2, 0, 2, -1)),
  ...
  "F Distribution" = distributionInfoClass(25, "FisherF", c("FdOne", "FdTwo"), c("d1", "d2"), c(1, 1)),
  "Fishers-Tippett Distribution" = distributionInfoClass(26, "FisherTippett", c("GEVMiu", "GEVSigma", "GEVEpsilon"), c("miu", "sigma", "Epsilon"), c(1, 1, 1), isWithSD = TRUE),
  ...
  "T Distribution" = distributionInfoClass(66, "StudentsT", c("Tdof"), c("degree of freedom"), c(1)),
  "T Non Central Distribution" = distributionInfoClass(67, "StudentsTNonCentral", c("TNCdof", "TNCNCP"), c("degree of freedom", "non-centrality parameter"), c(1, 1)),
