...
shinyUI(
  fluidPage(
    ...
    sidebarPanel(
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[5],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[6],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[7],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[12],"'",sep = ""),
                       textInput("ChiK",paste("Please input k for ",distributions[12]," : ",sep = ""),1)),
        # ----------------------- Input: Chi Square Distribution ----------------------- #
      conditionalPanel(condition = paste("input.Distribution == '",distributions[13],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[19],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[20],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == \"",distributions[29],"\"",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[30],"'",sep = ""),
                       textInput("GeomProb",paste("Please input Probability for ",distributions[30]," : ",sep = ""),0.5)),
      # ----------------------- Input: Gompertz Distribution ----------------------- #
      conditionalPanel(condition = paste("input.Distribution == '",distributions[32],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[33],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[34],"'",sep = ""),
                       textInput("HNorm",paste("Please input sigma for ",distributions[34]," : ",sep = ""),1)),
        # ----------------------- Input: Hyper Geometric Distribution ----------------------- #
      conditionalPanel(condition = paste("input.Distribution == '",distributions[35],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[43],"'",sep = ""),
                       textInput("LogP",paste("Please input P for ",distributions[43]," : ",sep = ""),0.5),),
        # ----------------------- Input: Logistic Distribution ----------------------- #
      conditionalPanel(condition = paste("input.Distribution == '",distributions[44],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[45],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[47],"'",sep = ""),
      ...
      # ----------------------- Input: Maxwell Distribution ----------------------- #
       conditionalPanel(condition = paste("input.Distribution == '",distributions[49],"'",sep = ""),
                        textInput("MaxwellA",paste("Please input a for ",distributions[49]," : ",sep = ""),1)),
      # ----------------------- Input: Minimax Distribution ----------------------- #
      conditionalPanel(condition = paste("input.Distribution == '",distributions[50],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[53],"'",sep = ""),
                       textInput("MuthKappa",paste("Please input parameter Kappa for ",distributions[53]," : ",sep = ""),1)),
      # ----------------------- Input: Negative Binomial Distribution ----------------------- #
      conditionalPanel(condition = paste("input.Distribution == '",distributions[54],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[55],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[59],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[60],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[65],"'",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == \"",distributions[66],"\"",sep = ""),
                       textInput("Tdof",paste("Please input degree of freedom for ",distributions[66]," : ",sep = ""),1)),
      # ----------------------- Input: T Non Central Distribution ----------------------- #
      conditionalPanel(condition = paste("input.Distribution == \"",distributions[67],"\"",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == \"",distributions[68],"\"",sep = ""),
      ...
      conditionalPanel(condition = paste("input.Distribution == '",distributions[75],"'",sep = ""),
    ...
    mainPanel(
      ...
      fluidRow(column(2,switchInput(inputId = "numericalValues", value = FALSE, onLabel = "Manual", offLabel = "Slider")),
               column(10,div(align = "left", conditionalPanel(condition = "input.numericalValues == 0 && (input.Distribution == 'Normal Distribution'
      ...
      conditionalPanel(condition = "input.numericalValues == 1",
                       fluidRow(column(3,numericInput(inputId="plotrangeNumMin", label="X-range Min:", value = -10)),
      ...
      conditionalPanel(condition = "input.numericalValues == 1",
                       fluidRow(column(3,numericInput(inputId="probrangeNumMin", label="Prob. Lower Bound:", value = -1)),
